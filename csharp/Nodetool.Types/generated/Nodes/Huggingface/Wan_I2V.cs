...
public class Wan_I2V
{
    ...
    [Key(6)]
    public Nodetool.Types.Core.ImageRef input_image { get; set; } = new Nodetool.Types.Core.ImageRef();
    [Key(7)]
    public int max_sequence_length { get; set; } = 512;
    [Key(8)]
    public object model_variant { get; set; } = @"Wan-AI/Wan2.2-I2V-A14B-Diffusers";
    [Key(9)]
    public string negative_prompt { get; set; } = @"";
    [Key(10)]
    public int num_frames { get; set; } = 81;
    [Key(11)]
    public int num_inference_steps { get; set; } = 50;
    [Key(12)]
    public string prompt { get; set; } = @"An astronaut walking on the moon, cinematic lighting, high detail";
    [Key(13)]
