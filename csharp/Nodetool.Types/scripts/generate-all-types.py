...
def generate_package_summary(output_dir: str, package_name: str, types: list, nodes: list, namespace: str) -> str:
    ...
    if types:
        types_summary_path = os.path.join(output_dir, "Types", f"{package_name}Types.cs")
...
/// <summary>
/// Provides access to all types from the {package_name} package.
/// This is an auto-generated file containing type information for the {package_name} package.
/// </summary>
public static class {package_name}Types
{{
    /// <summary>
    /// Provides static access to all type information in the {package_name} package.
    /// </summary>
    public static class Types
    {{
        #region Package Types
        // Types specific to the {package_name} package
...
""")
        summaries.append(f"{package_name}Types.cs")
    
    # Generate Nodes summary
    if nodes:
        nodes_summary_path = os.path.join(output_dir, "Nodes", f"{package_name}Nodes.cs")
...
namespace {namespace}.Nodes.{package_name};

/// <summary>
/// Provides access to all nodes from the {package_name} package.
/// This is an auto-generated file containing node information for the {package_name} package.
/// </summary>
public static class {package_name}Nodes
{{
    /// <summary>
    /// Provides static access to all node information in the {package_name} package.
    /// </summary>
    public static class Nodes
    {{
        #region Package Nodes
        // Node types from the {package_name} package
...
""")
        summaries.append(f"{package_name}Nodes.cs")
...
/// - Core types: {namespace}.Core.CoreTypes
{chr(10).join(f'/// - {pkg_name} types: {namespace}.{pkg_name}.{pkg_name}Types' for pkg_name, _ in generated_summaries)}
/// 
/// Nodes are organized into separate namespaces:
{chr(10).join(f'/// - {pkg_name} nodes: {namespace}.Nodes.{pkg_name}.{pkg_name}Nodes' for pkg_name, _ in generated_summaries)}
/// 
/// Usage:
/// var coreType = {namespace}.Core.CoreTypes.Types.AudioRef;  // Access core type
/// var packageType = {namespace}.Huggingface.HuggingfaceTypes.Types.AudioClassifier;  // Access package type
/// var node = {namespace}.Nodes.Huggingface.HuggingfaceNodes.Nodes.AudioClassifier;  // Access node type
